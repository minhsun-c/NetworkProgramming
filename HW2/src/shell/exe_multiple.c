...
static int doChild_nonbuiltin(command_t *cmd)
{
    char *arg[16];
...
static int doChild(command_t *cmd, int **fd, int idx)
{
...
static void close_parent_pipe(int **fd, int idx)
{
